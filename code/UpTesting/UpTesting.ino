...
void loop() {
  ...
  //float az = atan2(rawAccel[1], rawAccel[0]) * RAD2DEG;
  //float el = atan2(rawAccel[2], rawAccel[0]) * RAD2DEG;
  ...
  float theta = acos(x/1000)*RAD2DEG;
  float phi = acos(y/1000)*RAD2DEG;
